...
class PredictPriceLow(object):
    ...
    def make_predictions(self):
        ...
        # Save Model 
        model.save('../models/low_model.h5')
        # make predictions
    ...
    def get_plots(self):
        ...
        plt.xticks([])
        plt.title("Train Data Predicted and True Tomorrow's Low Price", fontsize=19)
        plt.legend()
        plt.tight_layout
        #plt.savefig('../imgs/low_train_lstm_tuned.png')
        plt.show()
        ...
        plt.xlabel('Historical Dates', fontsize=16)
        plt.xticks([])
        plt.title("Test Data Predicted and True Tomorrow's Low Price", fontsize=19)
        plt.legend()
        plt.tight_layout
        #plt.savefig('../imgs/low_test_lstm_tuned.png')
        plt.show();
    ...
    def return_todays_pred(self):
        ...
        print(f"I am tomorrow's Low: {finalPredict[0][0]:.2f}")
